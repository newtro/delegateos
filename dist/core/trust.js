...
export class TrustEngine {
    profiles = new Map();
    config;
    logger = createLogger('TrustEngine');
    /**
     ...
     */
    recordOutcome(principalId, attestation) {
