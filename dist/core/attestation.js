 ...
 */
export function createCompletionAttestation(signer, contractId, delegationId, result, childAttestations = []) {
    const attestation = {
 ...
 * @returns Signed Attestation
 */
export function createDelegationVerificationAttestation(signer, contractId, delegationId, result, childAttestations = []) {
    const attestation = {
        id: generateAttestationId(),
        version: '0.1',
        contractId,
 ...
 */
export function verifyAttestationSignature(attestation, signerPublicKey) {
